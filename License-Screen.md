...
3. Click the **Restart** link in the left menu under **Manage** and in the dialog that pops up click **OK** <p><img src="img/license-error-restart.png" width=600/>
4. Once you see a **Connected** Status for your Team (in 3-5 minutes) click on the **Teams** link in the left menu <p><img src="img/license-error-connected.png" width=600/>
5. Click on your Team and you should then see the **Create a new Pipeline** screen <p><img src="img/license-error-click-team.png" width=550/>